<head>
	...
	<link href="{{asset('minstore/plugins/font-awesome-4.7.0/css/font-awesome.min.css')}}" rel="stylesheet"
		type="text/css">
	<link rel="stylesheet" type="text/css" href="{{asset('minstore/plugins/OwlCarousel2-2.2.1/owl.carousel.css')}}">
	<link rel="stylesheet" type="text/css"
		href="{{asset('minstore/plugins/OwlCarousel2-2.2.1/owl.theme.default.css')}}">
	...
	<link rel="stylesheet" type="text/css" href="{{asset('minstore/styles/contact_styles.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('minstore/styles/contact_responsive.css')}}">
</head>
...
<body>
		...
		<div class="hamburger_menu">
			...
			<div class="hamburger_menu_content text-right">
				<ul class="menu_top_nav">
					...
					<li class="menu_item"><a href="https://www.facebook.com/profile.php?id=100088751558012">pages</a>
					</li>
			...
			<div class="row">
				<div class="col">
					...
					<div class="breadcrumbs d-flex flex-row align-items-center">
						<ul>
							<li><a href="/">Home</a></li>
							<li class="active"><a href="/contact"><i class="fa fa-angle-right"
			...
			<div class="row">
				...
				<div class="col-lg-6 contact_col">
					<div class="contact_contents">
						...
						<div>
							<p>{{ getConfigValueFromSettingTable('contactus') }}</p>
							<p>{{ getConfigValueFromSettingTable('email') }}</p>
						</div>
						<div>
							<p>{{ getConfigValueFromSettingTable('open_house') }}</p>
						</div>
						<div>
							<a href="{{ getConfigValueFromSettingTable('Pages') }}">Pages: Min Store</a>
						</div>
					</div>
					...
					<div class="follow_us_contents">
						...
						<ul class="social d-flex flex-row">
							<li><a href="{{ getConfigValueFromSettingTable('facebook_link') }}"
									style="background-color: #3a61c9"><i class="fa fa-facebook"
										aria-hidden="true"></i></a></li>
							<li><a href="{{ getConfigValueFromSettingTable('instagram_link') }}"
									style="background-color: #41a1f6"><i class="fa fa-twitter"
										aria-hidden="true"></i></a></li>
							<li><a href="{{ getConfigValueFromSettingTable('instagram_link') }}"
									style="background-color: #fb4343"><i class="fa fa-google-plus"
										aria-hidden="true"></i></a></li>
							<li><a href="{{ getConfigValueFromSettingTable('instagram_link') }}"
	...
	<script src="{{ asset('minstore/js/contact_custom.js') }}"></script>
</body>